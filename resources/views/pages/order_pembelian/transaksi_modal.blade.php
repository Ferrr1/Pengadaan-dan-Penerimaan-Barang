<x-modal name="transaksi_modal_order_pembelian" :show="false">
                                ...
                                <tr class="text-sm border-b-2 border-gray-200 dark:border-gray-700">
                                    ...
                                    <td class="px-5 py-5">
                                        <p class="whitespace-no-wrap">
                                            {{ $permintaan_pembelian->transaksi->kode_transaksi }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5">
                                        <p class="whitespace-no-wrap">
                                            {{ $permintaan_pembelian->transaksi->nama_transaksi }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 flex gap-2 items-center justify-start">
                                        ...
                                        <x-primary-button class="p-1" x-data
                                            x-on:click="
                                        $dispatch('select-transaksi', { id: '{{ $permintaan_pembelian->transaksi->id }}',kode: '{{ $permintaan_pembelian->transaksi->kode_transaksi }}', name: `{{ $permintaan_pembelian->transaksi->nama_transaksi }}` });
                                        $dispatch('close-modal', 'transaksi_modal_order_pembelian');">
