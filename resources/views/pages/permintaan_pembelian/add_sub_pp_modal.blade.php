    <x-modal name="sub_pp_modal" :show="false">
        <div class="p-6">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                Tambah Sub Permintaan Pembelian
            </h2>
            {{-- Table Start --}}
            <div>
                <div class="p-4 overflow-x-auto">
                    <form action="{{ route('subPermintaanPembelians.store', $permintaan_Pembelian->id) }}" method="POST">
                        @csrf
                        @method('POST')
                        <div x-data="{
                            subAnggaranId: '',
                            subAnggaranProdukId: '',
                            subAnggaranKodeProduk: '',
