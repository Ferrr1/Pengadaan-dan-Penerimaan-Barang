                            ...
                            <tr class="text-sm border-b-2 border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-5 py-5 flex gap-2 items-center justify-center">
                                    <x-primary-button class="p-2" x-data=""
                                        x-on:click="$dispatch('open-modal', `edit_modal_transaksi{{ $transaksi->id }}}`)">
                                        <x-eva-edit-2-outline class="w-5 h-5" />
                                    </x-primary-button>
                                    {{-- Delete Button --}}
                                    <x-danger-button class="p-2" x-data=""
                                        x-on:click="$dispatch('open-modal', `delete_modal_transaksi{{ $transaksi->id }}}`)">
                        ...
                        @empty
                            <tr>
                                <td colspan="6"
                                    ...
                                    Tidak ada data kelompok transaksi yang tersedia.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
