            ...
            <div>
                <div class="p-4 overflow-x-auto">
                    <form action="{{ route('subAnggarans.update', $subAnggaran->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div x-data="{ produkId: '{{ $subAnggaran->produks->id }}', produkKode: '{{ $subAnggaran->produks->kode_produk }}', produkName: '{{ $subAnggaran->produks->nama_produk }}', produkSatuan: '{{ $subAnggaran->produks->satuan->nama_satuan }}' }"
                                    ...
                                    <div class="relative">
                                        <div>
                                            <x-text-input id="kode_anggaran" class="block mt-1 w-full" type="text"
                                                ...
                                                value="{{ $subAnggaran->produks->kode_produk }}" />
