<x-modal name="produk_modal_sub_anggaran" :show="false">
    <div class="p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        ...
        {{-- Table Start --}}
        <input id="searchProdukModal" placeholder="Search" name="searchProdukModal"
        ...
        <div>
            <div class="pt-4 overflow-x">
                <div class="inline-block min-w-full shadow rounded-md overflow-x-auto w-full">
                    <table id="tableForSearchProdukModal" class="min-w-full leading-normal">
                                ...
                                <tr class="text-sm border-b-2 border-gray-200 dark:border-gray-700">
                                    ...
                                    <td class="px-5 py-5 flex gap-2 items-center justify-start">
                                        ...
                                        <x-primary-button class="p-1" x-data
                                            x-on:click="
                                        $dispatch('select-produk', { id: '{{ $produk->kode_produk }}',kode: '{{ $produk->kode_produk }}', name: '{{ $produk->nama_produk }}', satuan: '{{ $produk->satuan->nama_satuan }}' });
                                        $dispatch('close-modal', 'produk_modal_sub_anggaran');">
...
<script>
    document.getElementById('searchProdukModal').addEventListener('keyup', function() {
        const query = this.value.toLowerCase();
        const rows = document.querySelectorAll('#tableForSearchProdukModal tbody tr');
